...
export class BookService extends BaseService {
  ...
  static readonly ReturnedBorrowedBookPath = '/books/borrow/returned/{book-id}';
  ...
  static readonly ApprovedReturnedBorrowedBookPath = '/books/borrow/returned/approved/{book-id}';
