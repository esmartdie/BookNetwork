package com.esmartdie.book.email;
...
public class EmailService {
    ...
    public void sendEmail( String to, String username, EmailTemplateName emailTemplate,
                           String confirmationUrl, String activationCode, String emailSubject) throws MessagingException {
        ...
        helper.setFrom("esmartdietestingqa@gmail.com");
        helper.setTo(to);
